const Button = ({ children, className = '', ...props }) => {
    return (
        <button className={`overflow-hidden duration-300 ease-linear rounded-lg text-white uppercase lg:pt-[23px] pt-4 pb-3 lg:pb-[19px] px-5 lg:px-[26.5px] bg-linear-gradient-red z-[1] relative group ${className}`} {...props}>
