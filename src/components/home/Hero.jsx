    ...
    return (
        <section className='pb-0.5 relative'>
            ...
            <div className="container mt-5 relative z-10">
                ...
                <h2 className='xl:mt-7 mt-4 text-off-pink font-luckiest font-normal tracking-2xl !leading-2xl text-4xl sm:text-5xl lg:text-6xl md:px-4 xl:text-custom-3xl text-center xl:px-14'>Hoomin...Catch the Red Dot, Win CheeSburgerz</h2>
