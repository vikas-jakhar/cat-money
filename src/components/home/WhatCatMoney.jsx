...
const WhatCatMoney = () => {
    return (
        <section className='md:py-11 sm:py-7 py-5 relative'>
            <div className="container mb-14 pb-1">
                <div className="flex justify-between items-center gap-5 lg:flex-row flex-col">
                    <div className="max-w-[630px] w-full relative z-10">
                        ...
                        <p className='text-white font-barlow font-normal text-2xl sm:text-3xl text-center lg:text-left !leading-5xl mt-2 sm:mt-4'>Not just another meme token or game, CatMoney Catch is a revolutionary system designed to mix fun with real crypto earnings.</p>
