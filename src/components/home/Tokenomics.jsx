    ...
    return (
        <section className='bg-light-black lg:py-20 md:py-16 sm:py-14 py-12'>
            <div className="container lg:pb-2.5">
                ...
                <p className='text-center lg:text-left text-white font-comic font-bold sm:text-4xl text-2xl md:text-custom-6xl !leading-5xl'>1.5B Total Tokens. No Tax.</p>
                ...
                <div className="sm:mt-12 mt-8 lg:pt-1 flex justify-between items-center lg:flex-row flex-col xl:items-start gap-3">
                    ...
                    <img src={viewGraph} alt="viewGraph" className='max-w-[400px] w-full xl:hidden' />
